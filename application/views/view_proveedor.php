        ...
        <div class="page-content">
          <div class="page-header" >
            <h1>
              <i class="icon-home"></i> Mantenedor de Proveedor
              <small>
                <i class="icon-double-angle-right"></i>
                &nbsp;crea, edita proveedor.
              </small>
            </h1>
          </div><!-- /.page-header -->
                                ...
                                <div class="col-xs-12">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="table-responsive">
                                          ...
                                          <table id="table_proveedor" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                <thead>
                                  <tr>
                                    <th>Código</th>
                                    <th>Rut</th>
                        ...
                        $(document).ready(function() {
                          ...
                          table = $('#table_proveedor').DataTable({
                            ...
                            "ajax": {
                              "url": "<?php echo site_url('lista_proveedor')?>/" + <?php echo $id_empresa;?>,
                              "type": "POST"
                            },
                        ...
                        function edit_proveedor(id)
                        {
                          ...
                          $.ajax({
                            url : "<?php echo site_url('ajax_edit_proveedor/')?>/" + id,
                            type: "GET",
                            dataType: "JSON",
                            success: function(data)
                            {
                              $('[name="id_proveedor"]').val(data.id_proveedor);
                              $('[name="rut_proveedor"]').val(data.rut_proveedor);
                              $('[name="nombre_proveedor"]').val(data.nombre_proveedor);
                          ...
                          $.ajax({
                            ...
                            success: function(data)
                            {
                              ...
                              $('#fecha_modifica').css("font-weight","Bold").html(": " + data.fecha_modifica);
                                ...
                                $('.modal-title').text('Traza Proveedor código: ' + data.id_proveedor); // Set title to Bootstrap modal title
                        ...
                        function save()
                        {
                          ...
                          if(save_method == 'add')
                          {
                            url = "<?php echo site_url('save_proveedor')?>";
                          }
                          else
                          {
                            url = "<?php echo site_url('update_proveedor')?>";
                          }
            ...
            <form action="#" id="form" class="form-horizontal">
              ...
              <div class="form-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9">
                    <input name="rut_proveedor" placeholder="Rut" class="form-control" type="text" autocomplete="off">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9">
                    <input name="nombre_proveedor" placeholder="Nombre" class="form-control" type="text"autocomplete="off">
                    <span class="help-block"></span>
                  </div>
                </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body form">
              <form action="#" class="form-horizontal">
                <div class="form-body">
                  <div class="form-group">
                    <label class="col-sm-6 control-label">Usuario creaci&oacute;n Proveedor</label>
                    <label class="col-sm-6 control-label" id="username_guarda" style="text-align:left;"></label>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-md-6">Fecha creaci&oacute;n Proveedor</label>
