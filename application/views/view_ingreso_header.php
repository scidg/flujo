                            ...
                            <?php if(!empty($data_movimiento_detalle)){
                                    ...
                                    <div class="widget-box">
                                            ...
                                            <div class="widget-header widget-header-large">
                                                <h4>  <?php
                                                    if($id_m){
                                                        echo "FORMULARIO DE EDICI&Oacute;N > INGRESO Nº ".$id_m;
                                                    }else {
                                                        echo "FORMULARIO DE CREACI&Oacute;N > INGRESO Nº ".$devuelve_ultimo_id_ingreso;
                                                    }
                                                    ?></h4>
                                            </div>
...
function periodo_iva(val,id){
    ...
    if(!val.length == 0){
      ...
      $.ajax({
         url : "<?php echo site_url('muestra_periodo_iva/')?>" + val,
         type: "GET",
         dataType: "JSON",
         success: function(data)
          {   
