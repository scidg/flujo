    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
          <div class="page-header">
            <h1>
              <i class="icon-tags"></i> Mantenedor de Sucursal
              <small>
                <i class="icon-double-angle-right"></i>
                &nbsp;crea y edita sucursales.
              </small>
            </h1>
          </div><!-- /.page-header -->
          ...
          <div class="row">
                                <div class="col-xs-12">
                                  <!-- PAGE CONTENT BEGINS -->
                                  <div class="row">
                                  <p><button class="btn btn-success" onclick="add_sucursal()"><i class="glyphicon glyphicon-plus"></i> Agregar Sucursal</button></p>
                                </div><!-- /.page-content -->
                                  <div class="row">

                                    <div class="table-responsive">

                                          <table id="table-sucursal" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                <thead>
                                  <tr>
                                    <th>Código</th>
                                    <th>Empresa</th>
                        ...
                        $(document).ready(function() {
                          ...
                          table = $('#table-sucursal').DataTable({
                            ...
                            "ajax": {
                              "url": "<?php echo site_url('lista_sucursal')?>/" + <?php echo $id_empresa;?>,
                              "type": "POST"
                            },
                        ...
                        {
                          $('[name="id_empresa"]').parent().parent().removeClass('has-error');
                          $('[name="id_empresa"]').next().empty();
                      
                          $('[name="nombre_sucursal"]').parent().parent().removeClass('has-error');
                          $('[name="nombre_sucursal"]').next().empty();

                          $('[name="direccion_sucursal"]').parent().parent().removeClass('has-error');
                          $('[name="direccion_sucursal"]').next().empty();


                          save_method = 'add';
                          $('#form')[0].reset(); // reset form on modals
                          $('#modal_form').modal('show'); // show bootstrap modal
                          $('.modal-title').text('Agregar Sucursal'); // Set Title to Bootstrap modal title
                        }

                        function edit_sucursal(id)
                        {
                          ...
                          $.ajax({
                            url : "<?php echo site_url('ajax_edit_sucursal/')?>/" + id,
                            type: "GET",
                            dataType: "JSON",
                            success: function(data)
                            {
                              $('[name="id_sucursal"]').val(data.id_sucursal);
                              $('[name="id_empresa"]').val(data.id_empresa);
                              $('[name="nombre_sucursal"]').val(data.nombre_sucursal);
                              $('[name="direccion_sucursal"]').val(data.direccion_sucursal);
                          ...
                          $.ajax({
                            ...
                            success: function(data)
                            {
                              ...
                              $('#fecha_modifica').css("font-weight","Bold").html(": " + data.fecha_modifica);
                                ...
                                $('.modal-title').text('Traza Sucursal código: ' + data.id_sucursal); // Set title to Bootstrap modal title
                        ...
                        function save()
                        {
                          ...
                          if(save_method == 'add')
                          {
                            url = "<?php echo site_url('save_sucursal')?>";
                          }
                          else
                          {
                            url = "<?php echo site_url('update_sucursal')?>";
                          }
        ...
        <div class="modal-content">
          ...
          <div class="modal-body form">
            <form action="#" id="form" class="form-horizontal">
              <input type="hidden" value="" name="id_sucursal"/>
              ...
              <div class="form-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9">
                    <input name="nombre_sucursal" placeholder="Nombre" class="form-control" type="text" autocomplete="off">
                    <span class="help-block"></span>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9">
                    <input name="direccion_sucursal" placeholder="Direccion" class="form-control" type="text" autocomplete="off">
                    <span class="help-block"></span>
                  </div>
                </div>
                <div class="form-group">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body form">
              <form action="#" class="form-horizontal">
                <div class="form-body">
                  <div class="form-group">
                    <label class="col-sm-6 control-label">Usuario creaci&oacute;n Sucursal</label>
                    <label class="col-sm-6 control-label" id="username_guarda" style="text-align:left;"></label>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-md-6">Fecha creaci&oacute;n Sucursal</label>
