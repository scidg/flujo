        ...
        <div class="page-content">
          <div class="page-header">
            <h1>
              <i class="icon-suitcase"></i> Mantenedor de Cliente
              <small>
                ...
                &nbsp;crea, edita_cliente.
                              ...
                              <div class="row">
                                <button class="btn btn-success" onclick="add_cliente()"><i class="glyphicon glyphicon-plus"></i> Agregar Cliente</button>
                                <br />
                                <br />
                                <div class="col-xs-12">
                                  <!-- PAGE CONTENT BEGINS -->
                        ...
                        $(document).ready(function() {
                          ...
                          table = $('#table_cliente').DataTable({
                            ...
                            "ajax": {
                              "url": "<?php echo site_url('lista_cliente')?>/" + <?php echo $id_empresa;?>,
                              "type": "POST"
                            },
                        ...
                        function edit_cliente(id)
                        {
                          ...
                          $.ajax({
                            url : "<?php echo site_url('ajax_edit_cliente/')?>/" + id,
                            type: "GET",
                            dataType: "JSON",
                            success: function(data)
                            {
                              $('[name="id_cliente"]').val(data.id_cliente);
                              $('[name="rut_cliente"]').val(data.rut_cliente);
                          ...
                          $.ajax({
                            ...
                            success: function(data)
                            {
                              ...
                              $('#fecha_modifica').css("font-weight","Bold").html(": " + data.fecha_modifica);
                                ...
                                $('.modal-title').text('Traza Cliente código: ' + data.id_cliente); // Set title to Bootstrap modal title
                        ...
                        function save()
                        {
                          ...
                          if(save_method == 'add')
                          {
                            url = "<?php echo site_url('save_cliente')?>";
                          }
                          else
                          {
                            url = "<?php echo site_url('update_cliente')?>";
                          }
            ...
            <form action="#" id="form" class="form-horizontal">
              ...
              <div class="form-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9">
                    <input name="rut_cliente" placeholder="Rut" class="form-control" type="text" autocomplete="off">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9">
                    <input name="nombre_cliente" placeholder="Nombre" class="form-control" type="text" autocomplete="off">
                    <span class="help-block"></span>
                  </div>
                </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body form">
              <form action="#" class="form-horizontal">
                <div class="form-body">
                  <div class="form-group">
                    <label class="col-sm-6 control-label">Usuario creaci&oacute;n Cliente</label>
                    <label class="col-sm-6 control-label" id="username_guarda" style="text-align:left;"></label>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-md-6">Fecha creaci&oacute;n Cliente</label>
