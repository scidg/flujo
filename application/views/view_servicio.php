...
<div class="page-content">
          <div class="page-header">
            <h1>
              <i class="icon-bookmark"></i> Mantenedor de Servicios
              <small>
                <i class="icon-double-angle-right"></i>
                &nbsp;crea y edita servicio.
          ...
          <div class="row">
            <div class="col-xs-12">
              <!-- PAGE CONTENT BEGINS -->
              <div class="row">
              <p><button class="btn btn-success" id="add" onclick="add_servicio()"><i class="glyphicon glyphicon-plus"></i> Agregar Servicio</button></p>
            </div><!-- /.page-content -->
              <div class="row">

                <div class="table-responsive">

                      <table id="table-servicio" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
              <tr>
                <th>Código</th>
                <th>Nombre</th>
    ...
    $(document).ready(function() {
      ...
      table = $('#table-servicio').DataTable({
        ...
        "ajax": {
          "url": "<?php echo site_url('lista_servicio')?>/" + <?php echo $id_empresa;?>,
          "type": "POST"
        },
    ...
    {
      $('[name="nombre_servicio"]').parent().parent().removeClass('has-error');
      $('[name="nombre_servicio"]').next().empty();
  
      $('[name="estado"]').parent().parent().removeClass('has-error');
      $('[name="estado"]').next().empty();

      save_method = 'add';
      $('#form_servicio')[0].reset(); // reset form on modals
      $('#modal_form').modal('show'); // show bootstrap modal
      $('.modal-title').text('Agregar Servicios'); // Set Title to Bootstrap modal title
    ...
    function edit_servicio(id)
    {
      ...
      $.ajax({
        url : "<?php echo site_url('ajax_edit_servicio/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {

          $('[name="id_servicio"]').val(data.id_servicio);
          $('[name="quincena_servicio"]').val(data.id_quincena);
          $('[name="nombre_servicio"]').val(data.nombre_servicio);
      ...
      $.ajax({
        ...
        success: function(data)
        {
          ...
          $('#fecha_modifica').css("font-weight","Bold").html(": " + data.fecha_modifica);
            ...
            $('.modal-title').text(data.nombre_servicio); // Set title to Bootstrap modal title
    ...
    function save()
    {
      ...
      if(save_method == 'add')
      {
        url = "<?php echo site_url('save_servicio')?>";
      }
      else
      {
        url = "<?php echo site_url('update_servicio')?>";
      }
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body form">
            <form action="#" id="form_servicio" name="form_servicio" class="form-horizontal">
              <input type="hidden" value="" name="id_servicio"/>
              ...
              <div class="form-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9">
                    <select name="quincena_servicio" class="form-control">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9">
                    <input name="nombre_servicio" placeholder="Nombre" class="form-control" type="text" autocomplete="off">
                    <span class="help-block"></span>
                  </div>
                </div>
                <div class="form-group">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body form">
            <form action="#" class="form-horizontal">
              <div class="form-body">
                <div class="form-group">
                  <label class="col-sm-6 control-label">Usuario creaci&oacute;n servicio</label>
                  <label class="col-sm-6 control-label" id="username_guarda" style="text-align:left;"></label>
                </div>
                <div class="form-group">
                  <label class="control-label col-md-6">Fecha creaci&oacute;n servicio</label>
