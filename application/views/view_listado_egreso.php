...
<div class="page-content">
  <div class="page-header">
    <h1>
      <i class="icon-th-list"></i> Egresos
                          <small>
  ...
  <div class="row">
            ...
            $(document).ready(function() {
              ...
              table = $('#table-listado').DataTable({
                ...
                "ajax": {
                  "url": "<?php echo site_url('lista_egreso')?>/" + <?php echo $id_empresa;?>,
                  "type": "POST"
                },
    ...
    function activar(id)
    {
      ...
      if(result) {
          $.ajax({
              url : "<?php echo site_url('activar_egreso')?>",
              type: "POST",
            ...
            function traza_egreso(id)
            {

              //Ajax Load data from ajax
              $.ajax({
                url : "<?php echo site_url('ajax_data_egreso')?>/" + id,
                type: "GET",
                dataType: "JSON",
                success: function(data)
                {
                  ...
                  $('#fecha_modifica').css("font-weight","Bold").html(": " + data.fecha_modifica);
                    ...
                    $('.modal-title').text('Traza Egreso'); // Set title to Bootstrap modal title
        ...
        function detalle_egreso(id)
            {

              //Ajax Load data from ajax
              $.ajax({
                url : "<?php echo site_url('get_detalle_egreso/')?>/" + id,
                type: "GET",
                dataType: "JSON",
                success: function(data)
                {
