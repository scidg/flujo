        ...
        <div class="row"><!-- Inicia row Es Cuenta Banco -->
          ...
          <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
            ...
            <div class="input-group">
              <input class="form-control fin" id="fecha_ingreso_0" name="fecha_ingreso[]" type="text" data-date-format="yyyy-mm-dd" value="<?php echo $fecha_registro;?>"/>
      ...
      <?php } else { ?>
        ...
        <div class="row"><!-- Inicia row Tipo de Documento -->
          ...
          <div class="col-lg-1 col-md-1 col-sm-6 col-xs-12">
            ...
            <input type="text" class="form-control" id="numero_tipo_documento_0" name="numero_tipo_documento[]" placeholder="Numero" value="<?php echo $numero_tipo_documento;?>">
            <span class="help-block"></span>
            <input type="hidden" name="es_obligatorio[]" id="es_obligatorio_0"/>
          </div>
