...
class Manual_model extends CI_Model
{
  ...
  var $table = 'manual';
  var $column = array('id_manual','nombre_manual','id_modulo','id_submodulo','estado');
  var $order = array('id_manual' => 'desc');
  ...
  function get_datatables($id_empresa)
  {
    ...
    $this->db->select('id_manual,id_modulo,id_submodulo,nombre_manual,estado');
