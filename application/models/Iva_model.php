...
class Iva_model extends CI_Model
{
  ...
  var $table = 'iva';
  var $column = array('id_iva','nombre_iva','estado');
  var $order = array('id_iva' => 'desc');
  ...
  function get_datatables($id_empresa)
  {
    ...
    $this->db->select('id_iva,nombre_iva,estado');
  ...
  public function count_all($id_empresa)
  {
    ...
    function guarda_iva($data){

        $this->db->trans_start();
        $this->db->insert('iva', $data);
